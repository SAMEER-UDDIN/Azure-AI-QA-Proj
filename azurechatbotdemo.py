...
os.environ["AZURE_AI_SEARCH_SERVICE_NAME"] = "azurelibXXXX"

# Set the Azure AI Search index name to query
os.environ["AZURE_AI_SEARCH_INDEX_NAME"] = "azuretableXXXX"

# Set the Azure AI Search API key for authentication
os.environ["AZURE_AI_SEARCH_API_KEY"] = "XCISv445A6XXXXXXX"
...
llm = AzureChatOpenAI(
      ...
      azure_endpoint="https://samee-XXXXXXXX" ,
    api_key="AmwH69kn8tXXXXXXXXXXXXX",          # Fetch the API key for Azure OpenAI from environment variables
